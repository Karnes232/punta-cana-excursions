  ...
  return (
    <div ref={ref} className="flex flex-col gap-3">
      ...
      <a
        ...
        className="group flex items-center justify-center gap-2.5 w-full min-h-[48px] px-6 py-3.5 bg-whatsapp/10 text-whatsapp font-heading font-semibold text-sm tracking-wide rounded-xl border border-whatsapp/20 transition-all duration-500 ease-out hover:bg-whatsapp hover:text-white hover:border-whatsapp active:scale-[0.98] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-whatsapp"
        style={{
          opacity: isVisible ? 1 : 0,
          transform: isVisible ? "translateY(0)" : "translateY(10px)",
