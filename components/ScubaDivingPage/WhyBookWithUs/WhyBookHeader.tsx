...
/* ---------------------------------------------------------------------------
   WhyBookHeader — Centered heading + optional subheading
   
   Ocean-blue accent divider (instead of the Home page's sunset-orange).
   --------------------------------------------------------------------------- */

interface WhyBookHeaderProps {
  heading: string;
  subheading?: string;
}

export function WhyBookHeader({ heading, subheading }: WhyBookHeaderProps) {
  ...
  return (
    <div ref={ref} className="text-center mb-12 md:mb-16">
      ...
      <div
        ...
        aria-hidden="true"
      >
        <span className="block w-6 h-[3px] rounded-full bg-ocean/25" />
