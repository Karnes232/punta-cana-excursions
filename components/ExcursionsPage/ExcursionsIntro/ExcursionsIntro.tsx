...
interface ExcursionsIntroProps {
  eyebrow?: string;
  heading: string;
...
/**
 * SEO orientation block — sits between the hero and the filter chips.
 * Eyebrow + H2 + rich text giving Google page context and users orientation
 * before they start filtering.
 */
export function ExcursionsIntro({
  eyebrow,
  heading,
  body,
}: ExcursionsIntroProps) {
